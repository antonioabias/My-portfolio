...
const leftGroups = [
  ...
  },
  {
    category: "Front-end",
    items: [
      { name: "HTML", icon: "html", level: 8 },
      { name: "CSS", icon: "css", level: 8 },
      { name: "JavaScript", icon: "javascript", level: 8 },
      { name: "React", icon: "react", level: 7 },
      { name: "Next.js", icon: "nextjs", level: 5 },
      { name: "TypeScript", icon: "typescript", level: 7 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Java", icon: "java", level: 7 },
      { name: "C++", icon: "cpp", level: 6 },
    ],
  },
];
...
const rightGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "AWS", icon: "aws", level: 6 },
      { name: "GCP", icon: "gcp", level: 5 },
    ],
  },
];
